...
class CocoUtils:
    ...
    def convert_to_dataframe(self, file_caption_json_name:str):
        ...
        df['image_path'] = df["image_path"].apply(lambda x: self.root_folder_path + f'/train2017/{x}')
    ...
    @staticmethod
    def get_train_val_df(df:pd.DataFrame, val_size:float)->Union[pd.DataFrame, pd.DataFrame]:
